...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_ROOT}/../../CJPopupView/CJMaskGuideHUD/Resources/cjMaskGuideArrowDownWhite@2x.png"
  install_resource "${PODS_ROOT}/../../CJPopupView/CJMaskGuideView/CJMaskGuideResources/CJMaskGuide_ArrowDown@2x.png"
  install_resource "${PODS_ROOT}/../../CJPopupView/CJMaskGuideView/CJMaskGuideResources/CJMaskGuide_ArrowUp2@2x.png"
  install_resource "${PODS_ROOT}/../../CJPopupView/CJMaskGuideView/CJMaskGuideResources/CJMaskGuide_ArrowUp@2x.png"
  install_resource "${PODS_ROOT}/../../CJPopupView/CJMaskGuideView/CJMaskGuideResources/CJMaskGuide_ButtonMask_black@2x.png"
  install_resource "${PODS_ROOT}/../../CJPopupView/CJMaskGuideView/CJMaskGuideResources/CJMaskGuide_ButtonMask_white@2x.png"
  install_resource "${PODS_ROOT}/../../CJPopupView/CJMaskGuideView/CJMaskGuideResources/CJMaskGuide_ButtonOK@2x.png"
  install_resource "${PODS_ROOT}/../../CJPopupView/CJMaskGuideView/CJMaskGuideResources/CJMaskGuide_ButtonOKBG@2x.png"
fi
