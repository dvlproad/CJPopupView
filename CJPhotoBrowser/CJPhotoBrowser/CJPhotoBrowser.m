...
@property (nonatomic, copy) void (^selectNumCallBack)(NSInteger selectNum);
...
- (instancetype)initWithSelectNumCallBack:(void (^)(NSInteger selectNum))selectNumCallBack {
    self = [super init];
    if (self) {
        self.selectNumCallBack = selectNumCallBack;
    }
    return self;
}
...
- (void)createToolbar
{
    ...
    _toolbar.selectNumCallBack = ^(NSInteger selectNum)
    {
        ...
        if (self.selectNumCallBack) {
            self.selectNumCallBack(selectNum);
        }
    };
