...
@property (strong, nonatomic) TRWebDataManager *manager;
...
- (id)init {
    if ((self = [super init])) {
        _manager = [TRWebDataManager sharedManager];
...
- (void)startPrefetchingAtIndex:(NSUInteger)index {
    ...
    self.requestedCount++;
    [self.manager downloadDataWithURL:self.prefetchURLs[index] options:(TRWebDataOptions)self.options progress:nil completed:^(NSData *data, NSError *error, TRWebDataCacheType cacheType, NSURL *imageURL) {
