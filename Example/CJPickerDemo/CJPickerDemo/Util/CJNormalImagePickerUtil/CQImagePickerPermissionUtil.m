...
#import "CQImagePickerPermissionUtil.h"
...
@implementation CQImagePickerPermissionUtil
                  ...
                  pickCancelBlock:(void(^)(void))pickCancelBlock
{
    ...
    [singleImagePickerController pickImageFinishBlock:pickFinishBlock pickVideoFinishBlock:nil pickCancelBlock:pickCancelBlock];
