...
@interface CJBaseCollectionView () <UICollectionViewDataSource, UICollectionViewDelegate> {
...
@implementation CJBaseCollectionView
...
- (void)commonInit {
    ...
    self.maxShowCountPerRow = 4;    //默认每行的个数为4
